...
import { getTravelTimeMinutes } from "@/cities/mumbai/segmentTimings";
import { LINE_STATIONS, stations } from "@/cities/mumbai/metroData";
...
const INITIAL: JourneyState = {
  ...
  line: "blue" as "line1" | "line2a" | "line3" | "line7" | "line9",
  stops: [],
