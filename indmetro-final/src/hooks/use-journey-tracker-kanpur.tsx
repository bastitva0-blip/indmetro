...
import { getTravelTimeMinutes } from "@/cities/kanpur/segmentTimings";
import { LINE_STATIONS, stations } from "@/cities/kanpur/metroData";

export type KanpurLine = "orange" | "blue";
          ...
          if (prevDest && elapsedMin >= prevDest.etaMinutes && !notifiedRef.current.has(destId)) {
            ...
            try {
              if (Notification.permission === "granted")
                new Notification("IndMetro — Kanpur", {
