...
export default function KolkataIndex() {
  ...
  const [activeStationLine, setActiveStationLine] = useState<KolLine>("blue","green","orange","purple");
                ...
                <div key={l} className="flex items-center gap-2 py-1.5 border-b border-border last:border-0">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      {LINE_STATIONS[l].length} stations · {l === "blue","green","orange","purple" ? "Opened Apr 2026 🆕" : "Operational"}
                    </p>
                  </div>
                </div>
              ))}
