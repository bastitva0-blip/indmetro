...
import { LINE_TIMINGS, getHeadwayMinutes, FIRST_TRAIN, LAST_TRAIN } from "./segmentTimings";
import { getISTDate } from "@/lib/utils";

export interface TrainSchedule {
  id: string; line: "red"|"blue"|"green"; direction: "forward"|"backward";
...
export const getAllSchedules = (): TrainSchedule[] => {
  ...
  for (const line of ["red","blue","green"] as const) {
...
export const getNextTrainsAtStation = (
  stationId: string, line: "red"|"blue"|"green", direction: "forward"|"backward", count = 4
) => {
