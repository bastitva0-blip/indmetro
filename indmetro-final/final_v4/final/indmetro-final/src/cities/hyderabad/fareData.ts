/**
 * Hyderabad Metro — Fare System (HMRL)
 * Distance-based. ₹10–₹60. Tspay Card: 10% discount.
 */
...
export const FARE_ZONES: FareZone[] = [
  ...
  { zone: "F2", minKm: 2,  maxKm: 4,  fare: 15 },
  { zone: "F3", minKm: 4,  maxKm: 7,  fare: 20 },
  { zone: "F4", minKm: 7,  maxKm: 11, fare: 25 },
  { zone: "F5", minKm: 11, maxKm: 18, fare: 30 },
  { zone: "F6", minKm: 18, maxKm: 27, fare: 40 },
  { zone: "F7", minKm: 27, maxKm: Infinity, fare: 60 },
];
export const SMART_CARD = { name: "Tspay Card", discountPercent: 10, depositRupees: 50 };
...
export const getDistanceKm = (fromId: string, toId: string, line: "red"|"blue"|"green"): number => {
