...
import { getTravelTimeMinutes } from "@/cities/chennai/segmentTimings";
import { LINE_STATIONS, stations } from "@/cities/chennai/metroData";
          ...
          if (prevDest && elapsedMin >= prevDest.etaMinutes && !notifiedRef.current.has(destId)) {
            ...
            try {
              if (Notification.permission === "granted")
                new Notification("IndMetro — Chennai", {
