...
import { getTravelTimeMinutes } from "@/cities/navi_mumbai/segmentTimings";
import { LINE_STATIONS, stations, OPERATIONAL_STATIONS } from "@/cities/navi_mumbai/metroData";

export type BhopalLine = "line1";
  ...
  const startJourney = useCallback(
    async (boardingStationId: string, destinationStationId: string, line: BhopalLine) => {
      ...
      const stops: JourneyStop[] = ordered.map((id) => ({
        ...
        etaMinutes: getTravelTimeMinutes(boardingStationId, id) ?? 0,
      }));
