...
import { getTravelTimeMinutes } from "@/cities/meerut/segmentTimings";
import { LINE_STATIONS, stations } from "@/cities/meerut/metroData";
          ...
          if (prevDest && elapsedMin >= prevDest.etaMinutes && !notifiedRef.current.has(destId)) {
            ...
            try {
              if (Notification.permission === "granted")
                new Notification("IndMetro — Meerut", {
